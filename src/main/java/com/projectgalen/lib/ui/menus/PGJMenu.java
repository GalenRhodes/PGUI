...
public class PGJMenu extends JMenu {
    ...
    public PGJMenu(@NotNull String text, JComponent @NotNull ... items) {
        this(text, null, items);
    }

    public PGJMenu(@NotNull String text, @Nullable ActionListener listener, JComponent @NotNull ... items) {
        super(text);
